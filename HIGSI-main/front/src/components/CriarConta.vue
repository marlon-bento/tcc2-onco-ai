...
async function loginMetod() {
    ...
    if (username_input.value && password_input.value && email_input.value) {
        ...
        try {
            await login.criarConta(dataObject)
            toastStore.type = "success"
                ...
                toastStore.showToast(
                    "Conta criada com sucesso", "faça login", 1
                )
        } catch (e) {
                ...
                <div class="container-campos ">
                    <div class="container-tight">
                        <div class="d-flex align-items-center justify-content-between mb-5">
                            <div>
                                <h2 class="fs-1  bold mb-1 mt-0 p-0">Bem vindo!</h2>
                                <p class="fs-5 m-0 p-0"> Preencha os formulários abaixo como é devido para criar sua conta</p>
                            </div>
                            <div>
                        ...
                        <div class="card-body">
                            ...
                            <form @submit.prevent="loginMetod" id="form" method="post" autocomplete="off" novalidate>
                                <div class="mb-3">
                                    ...
                                    <input v-model="email_input" id="username" type="text" class="formulario"
                                        :class="emailEmpty ? 'is-invalid' : ''" name="email" placeholder="Digite seu email"
                                       >
                                    <div v-if="emailEmpty" class="invalid-feedback"> Email não
                                        digitado
                                    </div>
                                </div>
                                <div class="mb-3">
                        ...
                        <div class="mt-3 text-center">
                            <p>Já possui conta?   <router-link to="/login"
                                    href="">logar</router-link></p>
                        </div>
